$(document).ready(function(){
    /*--------------------搜索框样式控制js------------------------*/
	 var search_types={
        "types":[{name:"wd",action:"https://www.baidu.com/s",stype:"images/searchChoice/baidu.png",type:"baidu"},
                 {name:"query",action:"https://www.sogou.com/web",stype:"images/searchChoice/sougou.png",type:"sogou"},
                 {name:"q",action:"https://cn.bing.com/search",stype:"images/searchChoice/bing.png",type:"bing"},
                 {name:"q",action:"https://www.so.com/s",stype:"images/searchChoice/360.png",type:"so"},
                 {name:"q",action:"https://www.google.com/search",stype:"images/searchChoice/google.png",type:"google"},
                {name:"word",action:"http://www.cilimao.fashion/search",stype:"images/searchChoice/cili.png",type:"cili"},
                 {name:"key",action:"http://neets.cc/search",stype:"images/searchChoice/yingyin.png?v=1.1",type:"yingyin"},
                   {name:"q",action:"https://m.mijisou.com/?",stype:"images/searchChoice/mijisou.png",type:"mijisou"},
                 {name:"q",action:"https://quark.sm.cn/s?",stype:"images/searchChoice/shenmaai.png",type:"shenmaai"},
               {name:"text",action:"http://www.yandex.com/yandsearch?",stype:"images/searchChoice/Yandex.png",type:"yandex"},
